    ...
    },
    {
      ...
      items: [
        ...
        'features/event-sources',
        {
          type: 'category',
          label: 'AI Companions',
          link: { type: 'doc', id: 'features/ai-companions/index' },
          items: [
        ...
        {
          type: 'category',
          label: 'Claimed (Midnight)',
          link: { type: 'doc', id: 'features/claimed/index' },
          items: [
            'features/claimed/architecture',
            'features/claimed/verification-pipeline',
